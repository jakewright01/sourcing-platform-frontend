    ...
    <main className="flex min-h-screen flex-col items-center p-8 sm:p-12 bg-zinc-900 text-white">
      <div className="w-full max-w-2xl">
        <div className="flex justify-between items-center mb-10">
          <h1 className="text-4xl font-bold tracking-tighter">Add New Listing</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-black border border-zinc-800 rounded-2xl p-8 space-y-6">
          ...
          <div>
            <button type="submit" disabled={isSubmitting} className="w-full font-semibold py-3 px-4 bg-white text-black rounded-lg hover:bg-zinc-200 transition-all duration-300 disabled:bg-zinc-700 disabled:text-zinc-400 disabled:cursor-not-allowed cursor-pointer">
